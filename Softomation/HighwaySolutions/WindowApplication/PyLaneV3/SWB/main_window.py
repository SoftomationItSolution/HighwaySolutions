...
from SWB.wim_sock_connect import WimSocktConnect
...
class MainWindow(QWidget):
    ...
    def __init__(self, default_directory, plaza_config,script_dir):
        ...
        self.apipath = self.plaza_config["plaza_api_p"] + "Softomation/FastTrackHighway-TMS/"
    ...
    def init_ui(self):
        ...
        # Footer
        self.footer = FooterSection(height=50)
