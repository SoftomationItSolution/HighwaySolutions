class CommonManager:
    ...
    def getLaneDetailsGetByLaneId(dbConnectionObj,LaneId,current_date):
        try:
            
            params = [LaneId,current_date]
            resultData = dbConnectionObj.get_dataset_from_procedure('USP_LaneDetailsGetByLaneId', params)
            return resultData
        except Exception as e:
            raise e  
    ...
    def GetDioEquipmentDetails(dbConnectionObj, LaneId):
        try:
            params = [LaneId]
            resultData = dbConnectionObj.execute_procedure('USP_DioEquipmentDetailsGetByLaneId', params)
            return resultData
        except Exception as e:
            raise e
