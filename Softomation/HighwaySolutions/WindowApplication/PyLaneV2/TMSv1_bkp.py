...
def run_desktop_app(lane_equipments, dbConnectionObj, default_directory, systemSetting, lane_details, default_plaza_Id, logger):
...
if __name__ == '__main__':
    try:
        ...
        if lane_details is not None:
            if lane_details["LaneTypeId"]!=3:
                run_desktop_app(lane_equipments, dbConnectionObj, default_directory, systemSetting, lane_details, default_plaza_Id, logger)
    except Exception as e:
