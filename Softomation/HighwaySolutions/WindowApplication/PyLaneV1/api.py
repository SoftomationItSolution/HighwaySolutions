...
class FlaskApiApp:
    def __init__(self, default_directory, logger, bg_handler=None):
        self.stop_flask = threading.Event()
        ...
        self.app.add_url_rule('/shutdown', 'shutdown_system', self.shutdown)
    ...
    def run(self, debug=False):
        while not self.stop_flask.is_set():
            self.app.run(debug=debug, host='0.0.0.0', port=5002)           