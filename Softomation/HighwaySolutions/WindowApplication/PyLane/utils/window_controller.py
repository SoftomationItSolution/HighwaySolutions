...
class WindowController:
    ...
    def show_login(self,user_details):
        self.login = LoginUI(self.db,user_details,self.logger)
    ...
    def show_main(self,user_details):
        self.window = MainWindow(self.db,self.config_manager, user_details,self.systemSetting,self.project_config_data,self.logger,self.default_plaza_Id,self.system_ip)
