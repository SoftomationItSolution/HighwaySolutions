...
class AVC_Model:
    def __init__(self,dir_path,model_path='./avcc_v1.onnx', device_name="CPU"):
        self.core = ov.Core()
...
class AVC_Handler:
    def __init__(self,server_ip,server_port,default_directory,timeout=0.100):
