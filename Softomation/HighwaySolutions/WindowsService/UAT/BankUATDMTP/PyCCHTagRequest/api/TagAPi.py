...
class TagRequestApi:
    def __init__(self,dbConnectionObj:MSSQLConnectionManager, default_directory,icd_api_detail,plaza_details,private_key,certificate,app: FastAPI):
        ...
        self._add_routes()
        self.testingTags=["34161FA8203289A60555D200","34161FA8203289A60555D180","34161FA82032897226013560","34161FA820328972023B6540","34161FA8203289A603141400","34161FA8203289A604F90AA0"]
        #
        ...
        try:
            ...
            if len(resp_code)>0:
                ...
                if len(allowed_entries)>0:
                    ...
                    result=resp_code[0]
                    result['ISSUEDATE'] = result['ISSUEDATE'].strftime('%Y-%m-%d')
                    return {"status": "false", "VehicleDetails": result}
            else:
