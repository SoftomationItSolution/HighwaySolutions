...
from utils.icd_processing import ICdTagProcessing
from utils.log_master import CustomLogger


class IcdTagApiv1:
    def __init__(self):
        self.PID_FILE = "ICDTag_UATv1.pid"
        self.stop_event = threading.Event()
        self.default_directory = self.check_default_dir()
        self.script_dir=os.path.dirname(os.path.abspath(__file__))
        self.logger = CustomLogger(self.default_directory, 'icd_tag_app_UAT')
    ...
    def main(self):
        try:
            ...
            self.bg_handler = ICdTagProcessing(self.default_directory, dbConnectionObj)
