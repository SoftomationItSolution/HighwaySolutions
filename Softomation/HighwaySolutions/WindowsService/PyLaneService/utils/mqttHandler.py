...
class MqttHandler:
    def __init__(self, plaza_detail,lane_detail, default_directory):
        self.plaza_detail = plaza_detail
        self.lane_detail = lane_detail
        self.mqtt_client = None
        self.mqtt_topic = None
        self.mqtt_client_connected = False
        self.set_logger(default_directory,"MqttHandler")
    ...
    def create_mqtt_obj(self):
        try:
            ...
            self.mqtt_connect(self.plaza_detail['PlazaServerIpAddress'])
        except Exception as e:
            self.mqtt_client = None
