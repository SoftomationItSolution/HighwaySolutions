...
class LaneManager:
    ...
    @staticmethod
    def lane_lpic_media_pending(dbConnectionObj):
        try:
            resultData=dbConnectionObj.execute_procedure('USP_LaneLpicMediaPending', None)
            return resultData
        except Exception as e:
            raise e
        
    @staticmethod
    def lane_ic_media_pending(dbConnectionObj):
        try:
            resultData=dbConnectionObj.execute_procedure('USP_LaneIcMediaPending', None)
            return resultData
        except Exception as e:
            raise e
    ...
    @staticmethod
    def lane_lpic_media_marked_transfer(dbConnectionObj,d):
        try:
            params=[d["LaneTransactionId"]]
            resultData=dbConnectionObj.execute_procedure('USP_LaneLpicMediaMarkedTransfer', params)
            return resultData
        except Exception as e:
            raise e
        
    @staticmethod
    def lane_ic_media_marked_transfer(dbConnectionObj,d):
        try:
            params=[d["LaneTransactionId"]]
            resultData=dbConnectionObj.execute_procedure('USP_LaneIcMediaMarkedTransfer', params)
            return resultData
        except Exception as e:
            raise e
        
    @staticmethod
    def lane_media_marked_pending(dbConnectionObj,d):
        try:
            params=[d["LaneTransactionId"],d["CameraName"]]
            resultData=dbConnectionObj.execute_procedure('USP_LaneMediaMarkedPending', params)
            return resultData
        except Exception as e:
            raise e
