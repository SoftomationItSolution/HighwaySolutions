...
class LeftSection(QWidget):
    ...
    def setup_ui(self, default_directory, apipath, width):
        ...
        #main_layout.setObjectName("noborder")
        ...
        #frame.setObjectName("noborder")
        #frame_layout.setObjectName("noborder")
       
        group_box = QGroupBox("Vehicle Class")
        group_box.setFlat(True)  # This removes the default border from the GroupBox
        group_box_layout = QVBoxLayout()
        #group_box_layout.setObjectName("noborder")
        group_box.setLayout(group_box_layout)
        #group_box.setObjectName("noborder")
