...
@Component({
  selector: 'app-vsds-event-config',
  templateUrl: './vsds-event-config.component.html',
  styleUrls: ['./vsds-event-config.component.css']
})
export class VSDSEventConfigComponent {
  SystemId = 0;
  LogedRoleId;
  LogedUserId;
  DataUpdate: Number = 0;
