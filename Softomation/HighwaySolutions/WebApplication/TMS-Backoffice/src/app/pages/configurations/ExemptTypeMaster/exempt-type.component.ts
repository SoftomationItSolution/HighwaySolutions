...
@Component({
  selector: 'app-exempt-type.component',
  templateUrl: './exempt-type.component.html',
  styleUrls: ['./exempt-type.component.css']
})
export class ExemptTypeComponent implements OnInit {
  DevicesData: any;
  PermissionData:any;
  ErrorData: any;
  LogedRoleId=0;
  ...
  SaveDetails(){
    ...
    this.dbService.ExemptTypeUpdate(this.DevicesData).subscribe(
      data => {
        this.spinner.hide();
