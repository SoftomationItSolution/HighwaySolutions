...
@Component({
  selector: 'et-fasTag-response-declined',
  templateUrl: './fasTag-response-declined.component.html',
  styleUrls: ['./fasTag-response-declined.component.css']
})
export class FasTagResponseDeclined implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(private _compiler: Compiler, private dbService: apiIntegrationService,
    ...
    @Inject(MAT_DIALOG_DATA) parentData: any, public Dialogref: MatDialogRef<FasTagResponseDeclined>) {
  ...
  GetMasterData() {
    this.subscription = this.dbService.ICDResponseDeclined().subscribe(
      (data: any) => {
