...
{
    //: LaneTransactionIL
    public class LaneTransactionReviewIL 
    {
        Int64 transactionId;
        Int64 masterId;
        Int16 plazaId;
        ...
        String reveiwedDateTimeString;
        String reveiwedRemark;

        public LaneTransactionReviewIL()
        {
            ...
            this.reveiwedDateTimeString = string.Empty;
        ...
        public String ReveiwedDateTimeString
        {
            get
            {
                return reveiwedDateTimeString;
            }

            set
            {
                reveiwedDateTimeString = value;
            }
        }
