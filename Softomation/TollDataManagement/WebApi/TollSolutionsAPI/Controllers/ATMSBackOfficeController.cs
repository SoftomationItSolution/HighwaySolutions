...
namespace TollSolutionsAPI.Controllers
{
    ...
    public class ATMSBackOfficeController : ApiController
    {
        ...
        #region Login
        [Route(Provider + "/Transit360-ATMS/ValidateUser")]
        [HttpPost]
        public HttpResponseMessage ValidateUser(UserManagementIL login)
        {
            try
            {
                if (login.LoginId.ToLower() == "transit360")
                {
        ...
        [Route(Provider + "/Transit360-ATMS/LogoutUser")]
        [HttpPost]
