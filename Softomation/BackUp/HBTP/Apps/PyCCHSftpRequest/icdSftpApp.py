...
from utils.icd_processing import ICdSftpProcessing
from utils.log_master import CustomLogger


class IcdSftpAppv1:
    def __init__(self):
        self.PID_FILE = "ICDSftpv1.pid"
        self.stop_event = threading.Event()
        self.default_directory = self.check_default_dir()
        self.script_dir=os.path.dirname(os.path.abspath(__file__))
        self.logger = CustomLogger(self.default_directory, 'icd_sftp_app')
    ...
    def main(self):
        try:
            ...
            self.bg_handler = ICdSftpProcessing(self.default_directory, dbConnectionObj,db_json_data)
