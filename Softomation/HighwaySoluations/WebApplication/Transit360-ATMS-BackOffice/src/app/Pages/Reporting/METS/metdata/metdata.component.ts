...
import { METConfigPopupComponent } from '../metconfig-popup/metconfig-popup.component';


@Component({
  selector: 'app-metdata',
  templateUrl: './metdata.component.html',
  styleUrls: ['./metdata.component.css']
})
export class METDataComponent implements OnInit {
  ...
  GetDeviceData() {
    this.spinner.show();
    this.dbService.METGetLatest().subscribe(
      data => {
        this.spinner.hide();
